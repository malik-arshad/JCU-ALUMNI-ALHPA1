<?php
	...
	Copyright 2016  DK New Media  (email : info@dknewmedia.com)
	...
	class DK_Image_Rotator_Widget extends WP_Widget {
       ...
       */
		...
		public function __construct() {
			$widget_ops = array( 
				'classname' => 'dk-image-rotator-widget',
				'description' => 'A widgetized, bare bones image rotator.',
				);
			parent::__construct( 'dk-image-rotator-widget', 'Image Rotator Widget', $widget_ops );
		}
		...
		public function widget($args, $instance) {
			...
			if(isset($image_list) && $image_list != "") {
				...
				if ($instance['irw_new_window'] == 'true' ) { 
				...
				echo '<input type="hidden" class="irw-new-window" value="' . $irw_new_window . '" />';
