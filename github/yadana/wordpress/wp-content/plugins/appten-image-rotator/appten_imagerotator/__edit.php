    ...
    <tr>
     ...
     <tr>
      ...
      <td>   	
        ...
        <option value="boxedMask">Boxed Mask</option>
         <?php echo '<script>document.getElementById("'.$data->transition.'").selected="selected"</script>'; ?></select>
        </td>
	  </tr>  
      <tr>
      ...
      <td>   	
        ...
        <option value="float">Float</option>
         <?php echo '<script>document.getElementById("'.$data->navMode.'").selected="selected"</script>'; ?></select>
        </td>
	  </tr>  
      <tr>   
      ...
      <td>   	
        ...
        <option value="horizontal">Horizontal</option>
         <?php echo '<script>document.getElementById("'.$data->navType.'").selected="selected"</script>'; ?></select>
        </td>
	  </tr>  
      <tr>
